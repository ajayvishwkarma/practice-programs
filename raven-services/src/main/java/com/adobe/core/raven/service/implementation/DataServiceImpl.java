...
public class DataServiceImpl implements DataService {
    ...
    public String fetchSocialLink(String locale, String bu, String linkType) {
        ...
        List<SocialLinks> socialLinkList = socialLinks.parallelStream().filter(input -> (input.getPlatform().equalsIgnoreCase(linkType) && input.getProduct().equalsIgnoreCase(bu))).collect(Collectors.toList());
